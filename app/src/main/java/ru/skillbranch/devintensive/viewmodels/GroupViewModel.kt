...
class GroupViewModel : ViewModel() {
    ...
    fun getUsersData(): MutableLiveData<List<UserItem>> {
        ...
        val filterF = {
            ...
            else users.filter { it.fullName.contains(queryStr, ignoreCase = true) }
        }
    ...
    private fun loadUsers() = groupRepository.loadUsers().map{ it.toUserItem() }
}